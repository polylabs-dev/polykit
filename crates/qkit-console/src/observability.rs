...
//! Parameterized by lex namespace — works for any Q app.
...
impl WidgetProcessor for DeviationFeedProcessor {
    fn widget_type(&self) -> &str { "qkit-deviation-feed" }
...
impl WidgetProcessor for CapacityForecastProcessor {
    fn widget_type(&self) -> &str { "qkit-capacity-forecast" }
...
impl WidgetProcessor for SliDashboardProcessor {
    fn widget_type(&self) -> &str { "qkit-sli-dashboard" }
...
impl WidgetProcessor for CircuitHealthProcessor {
    fn widget_type(&self) -> &str { "qkit-circuit-health" }
...
impl WidgetProcessor for IncidentTimelineProcessor {
    fn widget_type(&self) -> &str { "qkit-incident-timeline" }
