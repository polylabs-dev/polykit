//! QKit Core — Thin kernel for runtime plumbing
//!
...
//!
//! See: circuits/fl/qkit_identity.fl (replaces identity.rs + crypto.rs)
//!      circuits/fl/qkit_metering.fl (replaces metering.rs)
